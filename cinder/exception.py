...
class VolumeHasSnapshot(CinderException):
    message = _("Rebuilding volume %(volume)s failed for reason: %(reason)s.")
...
class VolumeStatusCanNotBeRebuild(CinderException):
    message = _("Volume %(volume)s can not be rebuild %(reason)s ")
